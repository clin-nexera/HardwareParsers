...
if __name__ == "__main__":
    ...
    with open(timestamps_path, "r") as f:
        ...
        timestamps_data += timestamps_df.loc[timestamps_df["is_missed_pick"] == True][
            "index"
        ].tolist()

        timestamps_data += timestamps_df.loc[timestamps_df["is_dropped_pick"] == True][
            "index"
        ].tolist()
    ...
    for timestamp_data in timestamps_data:
        ...
        event_time = datetime.strptime(timestamp_data, "%Y%m%d_%H%M%S")
        ...
        event_time_start = event_time + timedelta(seconds=int(2))
        event_time_end = event_time + timedelta(seconds=int(10))
